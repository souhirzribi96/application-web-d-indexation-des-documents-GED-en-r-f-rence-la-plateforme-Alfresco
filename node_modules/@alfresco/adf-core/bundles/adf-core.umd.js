...
var AppConfigService =               (function () {
    function AppConfigService(http$$1) {
        ...
        this.onLoadSubject = new BehaviorSubject.BehaviorSubject(this.config);
...
var AlfrescoApiService =               (function () {
    function AlfrescoApiService(appConfig, storage) {
        ...
        this.nodeUpdated = new Subject.Subject();
    }
    ...
    AlfrescoApiService.prototype.load = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4          , this.appConfig.load().then(function () {
...
var LogLevelsEnum =               (function (_super) {
...
var LogService =               (function () {
    function LogService(appConfig) {
        this.appConfig = appConfig;
        this.onMessage = new Subject.Subject();
    }
...
var ViewerComponent =               (function () {
    function ViewerComponent(apiService, logService, location, el) {
        ...
        this.navigateBefore = new core.EventEmitter();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4          , this.resolveRendition(nodeId, 'pdf')];
                    case 2:
                        rendition = _a.sent();
                        if (rendition) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 8]);
                        return [4          , this.apiService.renditionsApi.getSharedLinkRendition(sharedId, 'pdf')];
                    case 2:
                        rendition = _a.sent();
                    ...
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4          , this.apiService.renditionsApi.getSharedLinkRendition(sharedId, 'imgpreview')];
                    case 5:
                        rendition = _a.sent();
                        if (rendition.entry.status.toString() === 'CREATED') {
                            this.viewerType = 'image';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4          , this.apiService.renditionsApi.getRenditions(nodeId)];
                    case 1:
                        supported = _a.sent();
                        ...
                        if (!(status === 'CREATED')) return [3          , 2];
                        return [2           , rendition];
                    case 2:
                        if (!(status === 'NOT_CREATED')) return [3          , 7];
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 6, , 7]);
                        return [4          , this.apiService.renditionsApi.createRendition(nodeId, { id: renditionId })];
                    case 4:
                        _a.sent();
                        return [4          , this.waitRendition(nodeId, renditionId, 0)];
    ...
    ViewerComponent.prototype.waitRendition = function (nodeId, renditionId, retries) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4          , this.apiService.renditionsApi.getRendition(nodeId, renditionId)];
                    case 1:
                        rendition = _a.sent();
                    ...
                    case 2:
                        retries += 1;
                        return [4          , this.wait(1000)];
                    case 3:
                        _a.sent();
                        return [4          , this.waitRendition(nodeId, renditionId, retries)];
...
ViewerComponent.propDecorators = {
    ...
    "urlFileViewer": [{ type: core.Input },],
    "blobFile": [{ type: core.Input },],
    "fileNodeId": [{ type: core.Input },],
    "sharedLinkId": [{ type: core.Input },],
    ...
    "allowNavigate": [{ type: core.Input },],
    "canNavigateBefore": [{ type: core.Input },],
    "canNavigateNext": [{ type: core.Input },],
    ...
    "thumbnailsTemplate": [{ type: core.Input },],
    "mimeType": [{ type: core.Input },],
    "fileName": [{ type: core.Input },],
    "downloadUrl": [{ type: core.Input },],
    "maxRetries": [{ type: core.Input },],
    ...
    "navigateBefore": [{ type: core.Output },],
    "navigateNext": [{ type: core.Output },],
...
var UserPreferencesService =               (function () {
    function UserPreferencesService(translate, appConfig, storage, apiService) {
        ...
        this.localeSubject = new BehaviorSubject.BehaviorSubject(this.defaults.locale);
        this.locale$ = this.localeSubject.asObservable();
        this.onChangeSubject = new BehaviorSubject.BehaviorSubject(this.userPreferenceStatus);
...
var ContentService =               (function () {
    ...
    ContentService.prototype.getNode = function (nodeId, opts) {
        return Observable.Observable.fromPromise(this.apiService.getInstance().nodes.getNode(nodeId, opts));
    };
...
var PdfPasswordDialogComponent =               (function () {
...
var PdfThumbListComponent =               (function () {
...
var ViewerToolbarActionsComponent =               (function () {
...
var NodeNameTooltipPipe =               (function () {
...
var InitialUsernamePipe =               (function () {
...
var HostSettingsComponent =               (function () {
    function HostSettingsComponent(settingsService, storage, logService, translationService) {
        ...
        this.providers = 'ALL';
        this.error = new core.EventEmitter();
        this.ecmHostChange = new core.EventEmitter();
        this.bpmHostChange = new core.EventEmitter();
...
HostSettingsComponent.propDecorators = {
    ...
    "error": [{ type: core.Output },],
    "ecmHostChange": [{ type: core.Output },],
    "bpmHostChange": [{ type: core.Output },],
};
var HostSettingsModule =               (function () {
...
PaginationComponent.propDecorators = {
    ...
    "isEmpty": [{ type: core.HostBinding, args: ['class.adf-pagination__empty',] },],
};
var InfinitePaginationComponent =               (function () {
...
var LanguageMenuModule =               (function () {
...
var SidebarActionMenuComponent =               (function () {
...
var NodeDeleteDirective =               (function () {
    ...
    NodeDeleteDirective.prototype.process = function (selection) {
        ...
        if (selection && selection.length) {
            ...
            Observable.Observable.forkJoin.apply(Observable.Observable, __spread(batch)).subscribe(function (data) {
...
var NodeFavoriteDirective =               (function () {
    ...
    NodeFavoriteDirective.prototype.toggleFavorite = function () {
        ...
        if (!every) {
            ...
            Observable.Observable.fromPromise(this.alfrescoApiService.getInstance().core.favoritesApi.addFavorite('-me-', (body)))
                .subscribe(function () {
...
var NodeRestoreDirective =               (function () {
...
var CardViewBoolItemModel =               (function (_super) {
...
var CardViewBoolItemComponent =               (function () {
...
var ɵ1 = moment$2.MAT_MOMENT_DATETIME_FORMATS;
...
CardViewDateItemComponent.decorators = [
    { type: core.Component, args: [{
                providers: [
                    ...
                    { provide: core$2.DatetimeAdapter, useClass: moment$2.MomentDatetimeAdapter },
...
CardViewDateItemComponent.propDecorators = {
    ...
    "editable": [{ type: core.Input },],
    "displayEmpty": [{ type: core.Input },],
    "datepicker": [{ type: core.ViewChild, args: ['datetimePicker',] },],
};
...
var DynamicComponentResolver =               (function () {
...
var DynamicComponentMapper =               (function () {
...
var CardItemTypeService =               (function (_super) {
...
var CardViewItemIntValidator =               (function () {
...
var CardViewItemFloatValidator =               (function () {
...
var CardViewDatetimeItemModel =               (function (_super) {
...
var CardViewFloatItemModel =               (function (_super) {
...
var CardViewIntItemModel =               (function (_super) {
...
var MinDateTimeFieldValidator =               (function () {
...
var MaxDateTimeFieldValidator =               (function () {
...
var DynamicRowValidationSummary =               (function (_super) {
...
var PeopleProcessService =               (function () {
...
var ɵ1$1 = moment$2.MAT_MOMENT_DATETIME_FORMATS;
var DateTimeWidgetComponent =               (function (_super) {
...
DateTimeWidgetComponent.decorators = [
    { type: core.Component, args: [{
                providers: [
                    ...
                    { provide: core$2.DatetimeAdapter, useClass: moment$2.MomentDatetimeAdapter },
                    { provide: core$2.MAT_DATETIME_FORMATS, useValue: ɵ1$1 }
                ],
...
var ActivitiContentService =               (function () {
    ...
    ActivitiContentService.prototype.getAlfrescoRepositories = function (tenantId, includeAccount) {
        ...
        return Observable.Observable.fromPromise(apiService.activiti.alfrescoApi.getRepositories(opts))
            .map(this.toJsonArray)
            .catch(function (err) { return _this.handleError(err); });
    };
    ...
    ActivitiContentService.prototype.applyAlfrescoNode = function (node, siteId, accountId) {
        ...
        return Observable.Observable.fromPromise(apiService.activiti.contentApi.createTemporaryRelatedContent(params))
            .map(this.toJson)
            .catch(function (err) { return _this.handleError(err); });
    };
...
var FormFieldComponent =               (function () {
    ...
    FormFieldComponent.prototype.createComponentFactorySync = function (compiler, metadata, componentClass) {
        ...
        var decoratedCmp = core.Component(metadata)(cmpClass);
...
var SidenavLayoutContentDirective =               (function () {
...
var SidenavLayoutHeaderDirective =               (function () {
...
var SidenavLayoutNavigationDirective =               (function () {
...
var SidenavLayoutComponent =               (function () {
...
SidenavLayoutComponent.propDecorators = {
    "sidenavMin": [{ type: core.Input },],
    "sidenavMax": [{ type: core.Input },],
    "stepOver": [{ type: core.Input },],
    "hideSidenav": [{ type: core.Input },],
    "expandedSidenav": [{ type: core.Input },],
    "headerDirective": [{ type: core.ContentChild, args: [SidenavLayoutHeaderDirective,] },],
    "navigationDirective": [{ type: core.ContentChild, args: [SidenavLayoutNavigationDirective,] },],
    "contentDirective": [{ type: core.ContentChild, args: [SidenavLayoutContentDirective,] },],
    "container": [{ type: core.ViewChild, args: ['container',] },],
    "emptyTemplate": [{ type: core.ViewChild, args: ['emptyTemplate',] },],
};
...
var contentAnimation = animations.trigger('contentAnimation', [
    animations.state('expanded', animations.style({ 'margin-left': '{{ marginLeft }}px' }), { params: { marginLeft: 0 } }),
    animations.state('compact', animations.style({ 'margin-left': '{{ marginLeft }}px' }), { params: { marginLeft: 0 } }),
    animations.transition('expanded <=> compact', animations.animate('400ms cubic-bezier(0.25, 0.8, 0.25, 1)'))
]);
var LayoutContainerComponent =               (function () {
...
LayoutContainerComponent.propDecorators = {
    "sidenavMin": [{ type: core.Input },],
    "sidenavMax": [{ type: core.Input },],
    "mediaQueryList": [{ type: core.Input },],
    "hideSidenav": [{ type: core.Input },],
    "expandedSidenav": [{ type: core.Input },],
    "sidenav": [{ type: core.ViewChild, args: [material.MatSidenav,] },],
};
var SidenavLayoutModule =               (function () {
...
var CommentProcessService =               (function () {
...
var CommentContentService =               (function () {
    ...
    CommentContentService.prototype.addNodeComment = function (nodeId, message) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().core.commentsApi.addComment(nodeId, { content: message }))
            .map(function (response) {
            return new CommentModel({
    ...
    CommentContentService.prototype.getNodeComments = function (nodeId) {
        var _this = this;
        return Observable.Observable.fromPromise(this.apiService.getInstance().core.commentsApi.getComments(nodeId))
            .map(function (response) {
            var comments = [];
...
var CommentsComponent =               (function () {
    function CommentsComponent(commentProcessService, commentContentService) {
        ...
        this.comment$ = new Observable.Observable(function (observer) { return _this.commentObserver = observer; }).share();
...
var AuthGuardEcm =               (function () {
    function AuthGuardEcm(authService, apiService, router$$1, appConfig) {
        this.authService = authService;
        this.apiService = apiService;
        this.router = router$$1;
        this.appConfig = appConfig;
...
var AppsProcessService =               (function () {
...
var RenditionsService =               (function () {
    ...
    RenditionsService.prototype.pollRendition = function (nodeId, encoding, interval$$1, retries) {
        var _this = this;
...
var TranslateLoaderService =               (function () {
    ...
    TranslateLoaderService.prototype.getComponentToFetch = function (lang) {
        ...
        this.providers.forEach(function (component) {
            if (!_this.isComponentInQueue(lang, component.name)) {
                ...
                var loader = Observable.Observable.create(function (observer) {
                    var translationUrl = component.path + "/" + _this.prefix + "/" + lang + _this.suffix + "?v=" + Date.now();
                    _this.http.get(translationUrl).pipe(operators.map(function (res) {
...
var minimatch = minimatch___default__default__default || minimatch___default__default;
...
var FavoritesApiService =               (function () {
...
var PeopleContentService =               (function () {
...
var SearchConfigurationService =               (function () {
...
var CommentProcessModel =               (function () {
...
var AppConfigServiceMock =               (function (_super) {
...
var CookieServiceMock =               (function (_super) {
...
var AlfrescoApiServiceMock =               (function (_super) {
...
var SideBarActionModule =               (function () {
...
var ɵ0$4 = (createTranslateLoader);
var CoreModuleLazy =               (function () {
...
var ɵ1$2 = (createTranslateLoader);
var ɵ2 = startupServiceFactory;
...
exports.ɵg = BaseEvent;
exports.ɵf = BaseUIEvent;
exports.ɵk = StartFormCustomButtonDirective;
exports.ɵj = FormFieldComponent;
exports.ɵi = DynamicRowValidationSummary;
exports.ɵh = WidgetVisibilityService;
exports.ɵd = MaterialModule;
exports.ɵc = modules;
exports.ɵr = getType;
exports.ɵu = startupServiceFactory;
exports.ɵt = SideBarActionModule;
exports.ɵs = declarations$1;
exports.ɵo = LayoutContainerComponent;
exports.ɵn = SidenavLayoutContentDirective;
exports.ɵl = SidenavLayoutHeaderDirective;
exports.ɵm = SidenavLayoutNavigationDirective;
exports.ɵq = contentAnimation;
exports.ɵp = sidenavAnimation;
exports.ɵe = PdfPasswordDialogComponent;
exports.ɵb = RenderingQueueServices;
