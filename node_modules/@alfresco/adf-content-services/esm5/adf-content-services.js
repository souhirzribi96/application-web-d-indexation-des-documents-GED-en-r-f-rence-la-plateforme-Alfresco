import { __awaiter, __spread, __extends, __read, __generator, __values } from 'tslib';
...
var DocumentListService = /** @class */ (function () {
    ...
    DocumentListService.prototype.copyNode = function (nodeId, targetParentId) {
        var _this = this;
        return Observable.fromPromise(this.apiService.getInstance().nodes.copyNode(nodeId, { targetParentId: targetParentId }))
            .catch(function (err) { return _this.handleError(err); });
    };
    DocumentListService.prototype.moveNode = function (nodeId, targetParentId) {
        var _this = this;
        return Observable.fromPromise(this.apiService.getInstance().nodes.moveNode(nodeId, { targetParentId: targetParentId }))
            .catch(function (err) { return _this.handleError(err); });
    };
    DocumentListService.prototype.createFolder = function (name, parentId) {
        var _this = this;
        var observable = Observable.fromPromise(this.apiService.getInstance().nodes.createFolder(name, '/', parentId));
...
var TagService = /** @class */ (function () {
    ...
    TagService.prototype.addTag = function (nodeId, tagName) {
        ...
        tagBody.tag = tagName;
        var promiseAdd = Observable.fromPromise(this.apiService.getInstance().core.tagsApi.addTag(nodeId, tagBody));
    ...
    TagService.prototype.removeTag = function (nodeId, tag) {
        var _this = this;
        var promiseRemove = Observable.fromPromise(this.apiService.getInstance().core.tagsApi.removeTag(nodeId, tag));
...
var CustomResourcesService = /** @class */ (function () {
    ...
    CustomResourcesService.prototype.loadTrashcan = function (pagination, includeFields) {
        ...
        return Observable.fromPromise(this.apiService.nodesApi.getDeletedNodes(options)).catch(function (err) { return _this.handleError(err); });
    };
    CustomResourcesService.prototype.loadSharedLinks = function (pagination, includeFields) {
        ...
        return Observable.fromPromise(this.apiService.sharedLinksApi.findSharedLinks(options)).catch(function (err) { return _this.handleError(err); });
    };
...
var FileUploadingListComponent = /** @class */ (function () {
    ...
    FileUploadingListComponent.prototype.cancelAllFiles = function () {
        ...
        Observable.forkJoin.apply(Observable, __spread(deletedFiles)).subscribe(function (files) {
            var errors = files
...
var UploadButtonComponent = /** @class */ (function (_super) {
    ...
    function UploadButtonComponent(uploadService, contentService, translateService, logService) {
        ...
        _this.createFolder = new EventEmitter();
...
var UploadDragAreaComponent = /** @class */ (function (_super) {
    ...
    UploadDragAreaComponent.prototype.onFilesDropped = function (files) {
        ...
        if (!this.disabled && files.length) {
            var fileModels = files.map(function (file) { return new FileModel(file, {
    ...
    UploadDragAreaComponent.prototype.onFolderEntityDropped = function (folder) {
        ...
        if (!this.disabled && folder.isDirectory) {
            FileUtils.flattern(folder).then(function (entries) {
    ...
    UploadDragAreaComponent.prototype.onUploadFiles = function (event) {
        ...
        if (isAllowed) {
            ...
            if (files && files.length > 0) {
                ...
                var fileModels = files.map(function (fileInfo) { return new FileModel(fileInfo.file, {
                    newVersion: _this.versioning,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.searchApi.search(query)];
                    case 1:
                        data = _b.sent();
...
var SearchTriggerDirective = /** @class */ (function () {
    ...
    Object.defineProperty(SearchTriggerDirective.prototype, "outsideClickStream", {
        get: function () {
            ...
            return merge(fromEvent(this.document, 'click'), fromEvent(this.document, 'touchend')).filter(function (event) {
...
var SearchScopeLocationsComponent = /** @class */ (function () {
...
var SearchWidgetsModule = /** @class */ (function () {
...
var ContentMetadataService = /** @class */ (function () {
    ...
    ContentMetadataService.prototype.getGroupedProperties = function (node, presetName) {
        var _this = this;
        if (presetName === void 0) { presetName = 'default'; }
        var groupedProperties = Observable.of([]);
        if (node.aspectNames) {
